...
public class myBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Post> list = mpService.selectBoardList(userNo, currentPage, boardLimit);
		...
		if (list.size() != 0 && list.size() != 0) {
			...
			request.getRequestDispatcher("views/myPageUpdate/myBoard.jsp").forward(request, response);
